...
public class OfflinePlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String getPlayerOneName = getIntent().getStringExtra("Người chơi 1");
        final String getPlayerTwoName = getIntent().getStringExtra("Người chơi 2");
    ...
    private void performAction(ImageView imageView, int selectedBoxPosition) {
        ...
        OfflineWinDialog offlineWinDialog;
        if (playerTurn == 1) {
            imageView.setImageResource(R.drawable.cross_icon);
            if (checkPlayerWin()) {
                 offlineWinDialog = new OfflineWinDialog(OfflinePlay.this, playerOneName.getText().toString() + " chiến thắng", OfflinePlay.this);
                offlineWinDialog.setCancelable(false);
                offlineWinDialog.show();

            }
            else if (totalSelectedBoxes == 9) {
                 offlineWinDialog = new OfflineWinDialog(OfflinePlay.this, "Hòa nhau", OfflinePlay.this);
                offlineWinDialog.setCancelable(false);
                offlineWinDialog.show();
            }
            else {
            ...
            if (checkPlayerWin()) {
                 offlineWinDialog = new OfflineWinDialog(OfflinePlay.this, playerTwoName.getText().toString() + " chiến thắng", OfflinePlay.this);
                offlineWinDialog.setCancelable(false);
                offlineWinDialog.show();
    ...
    private void changePlayerTurn(int currenPlayerTurn) {
        playerTurn = currenPlayerTurn;
        if (playerTurn == 1) {
